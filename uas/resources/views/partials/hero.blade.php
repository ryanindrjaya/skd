<div class="relative px-6 lg:px-8">
  <div class="mx-auto max-w-3xl pt-20 pb-32 sm:pt-48 sm:pb-40">
    <div>
      ...
      <div>
        <h1 class="text-4xl font-bold tracking-tight sm:text-center sm:text-6xl">Toko Online Terpercaya <br /> Harga
          Terbaik
          & Terjangkau
        </h1>
        <p class="mt-6 text-lg leading-8 text-gray-600 sm:text-center">Semua Ada dan Bisa. Dari Kebutuhan Harian Sampai
          Bayar Tagihan. Lebih Hemat. Belanja Berbagai Produk Terkini, Bisa Bebas Ongkir Ke Seluruh Indonesia. Cek
          Sekarang. Beragam Metode Pembayaran.</p>
