    ...
    <div class="pt-24">
      <nav aria-label="Breadcrumb">
        <ol role="list" class="mx-auto flex max-w-2xl items-center space-x-2 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
          ...
          <li>
            <div class="flex items-center">
              <a href="/catalog" class="mr-2 text-sm font-medium text-gray-900">Belanja</a>
          ...
          <li class="text-sm">
            <a href="#" aria-current="page"
              class="font-medium text-gray-500 hover:text-gray-600">{{ $produk->nama }}</a>
          </li>
        </ol>
      </nav>
      ...
      <div class="mx-auto mt-6 max-w-2xl sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
        <div class="aspect-w-4 aspect-h-5 sm:overflow-hidden sm:rounded-lg lg:aspect-w-3 lg:aspect-h-4">
          <img src="{{ asset('img/' . $produk->foto) }}" alt="Model wearing plain white basic tee."
            class="h-full w-full object-cover object-center">
        </div>

        <div class="">
          <div class="lg:pr-8">
            <h1 class="text-2xl font-bold tracking-tight mb-2 text-gray-900 sm:text-3xl">{{ $produk->nama }}</h1>
          </div>
          ...
          <div class="mt-4 lg:mt-0">
            ...
            <p class="text-3xl tracking-tight text-gray-900">{{ rupiah($produk->harga) }}</p>
