...
<body>
  <div class='bg-blue-500 h-screen w-full flex justify-center items-center'>
    ...
    <form action="enkcaesar.php" method="get" class="w-1/4 shadow-xl p-8 bg-white rounded-lg border flex flex-col">
      <h1 class='text-3xl font-bold text-center mb-6 text-gray-600'>Caesar Cipher</h1>
      <label class='text-lg mb-3' for="plain_text">Plainteks</label>
      ...
      <input type="submit" name='submit' class='cursor-pointer bg-blue-400 py-3 px-4 rounded-lg text-white' value='Enkripsi'>
    </form>
  </div>
</body>
</html>