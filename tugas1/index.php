  ...
  <header class="text-gray-700 body-font border-b border-gray-200">
    <div class="container mx-auto flex justify-between flex-wrap p-5 flex-col md:flex-row items-center">
      <a class="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0" href="https://tailblocks.cc" target="_blank">
        ...
        <span class="ml-3 text-xl">KELOMPOK 1</span>
      </a>
      <a href="login.php">
        <button class="inline-flex items-center bg-indigo-300 duration-150 border-0 py-1 px-3 focus:outline-none hover:bg-indigo-600 text-white rounded text-base py-2 px-4 mt-4 md:mt-0">Login
    ...
    <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
      <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
        <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">Before they sold out
          <br class="hidden lg:inline-block">gluten
        </h1>
